  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col bg-[#0d1117] text-gray-100 font-sans selection:bg-teal-500/30 rounded-2xl border border-gray-800 overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          {activeQuestion?.outboundUrl && (
            <a
              ...
              className="px-2.5 py-1 text-xs rounded-md bg-teal-500/10 hover:bg-teal-500/20 text-teal-300 border border-teal-500/30 flex items-center gap-1 transition"
      ...
      <div className="flex-1 flex relative overflow-hidden">
        ...
        {showDrawer && (
          <aside className="w-80 border-r border-gray-800 bg-[#161b22] flex flex-col z-30 shadow-2xl absolute inset-y-0 left-0">
            ...
            {/* Filter Controls */}
            <div className="p-3 border-b border-gray-800/80 space-y-2.5 bg-[#12161c]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#1c2128] border border-gray-700 rounded-md pl-8 pr-3 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-teal-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <select
                  ...
                  className="bg-[#1c2128] border border-gray-700 rounded px-2 py-1 text-gray-300 focus:outline-none focus:border-teal-500"
                >
        ...
        <div className="w-1/2 border-r border-gray-800 flex flex-col bg-[#0d1117] overflow-y-auto">
          {loadingQuestion ? (
            <div className="p-8 flex flex-col items-center justify-center text-gray-500 gap-3 min-h-[400px]">
                ...
                <div className="space-y-3">
                  ...
                  {visibleTestCases.map((tc, idx) => (
                    ...
                    >
                      ...
                      {tc.explanation && (
                        <div className="text-gray-500 text-[11px] font-sans pt-1 border-t border-gray-800/80">
                          <span className="text-gray-400">Explanation:</span> {tc.explanation}
                        </div>
                      )}
                    </div>
                  ))}
                ...
                <div className="pt-4 border-t border-gray-800/80">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {activeQuestion.companyTags.map((company) => (
                      <span
                        key={company}
                        className="text-[11px] px-2 py-0.5 rounded bg-gray-800/80 text-gray-300 border border-gray-700/60"
                      >
                        {company}
                      </span>
                    ))}
        ...
        <div className="w-1/2 flex flex-col bg-[#161b22]">
          ...
          <div className="h-11 border-b border-gray-800 bg-[#161b22] px-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400">Language:</span>
              <select
                value={selectedLanguage}
                onChange={(e) => handleLanguageChange(e.target.value as SupportedLanguage)}
                className="bg-[#1c2128] border border-gray-700 text-teal-300 font-medium text-xs rounded px-2.5 py-1 focus:outline-none focus:border-teal-500"
              >
          ...
          <div className="h-64 border-t border-gray-800 bg-[#0d1117] flex flex-col">
            {/* Tabs Bar */}
            <div className="h-9 border-b border-gray-800 bg-[#161b22] px-3 flex items-center justify-between">
            ...
            <div className="flex-1 p-3 overflow-y-auto text-xs font-mono">
              ...
              {activeBottomTab === 'result' && (
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {lastExecutionResult.testResults.map((tr, idx) => (
                        ...
                        >
                          ...
                          {!tr.isHidden && (
                            <>
                              <div className="text-gray-400 text-[11px]">Input: {tr.input}</div>
                  ...
                  {!lastExecutionResult && !isRunning && !isSubmitting && (
                    <div className="text-gray-500 py-6 text-center font-sans text-xs">
              ...
              {activeBottomTab === 'submissions' && (
                <div className="space-y-2">
                  {loadingSubmissions ? (
                    <div className="py-4 text-center text-gray-500">Loading submission history...</div>
                  ) : submissions.length > 0 ? (
                    submissions.map((sub) => (
                      <div
                        key={sub.id}
                        className="p-2.5 rounded bg-[#161b22] border border-gray-800 flex items-center justify-between"
                      >
                        <div className="flex items-center gap-2">
                          <CheckCircle2
                            className={`w-4 h-4 ${
                          ...
                          />
                          <div>
                            <span className="font-bold text-gray-200">{sub.status}</span>
                            <span className="text-gray-500 text-[10px] ml-2">[{sub.language}]</span>
                          </div>
                        </div>
