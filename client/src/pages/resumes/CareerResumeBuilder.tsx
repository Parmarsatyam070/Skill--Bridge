    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-line">
        <div>
          <div className="flex items-center gap-2">
            <Link
              to="/profile"
              className="text-xs font-mono text-ink-muted hover:text-bridge-teal flex items-center gap-1"
            >
          ...
          {activeResume ? (
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-paper hover:bg-line border border-line text-ink text-xs font-semibold transition-colors"
              >
                Back to My Resumes
              </button>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-paper hover:bg-line border border-line text-ink text-xs font-semibold transition-colors"
              >
          ...
          <div className="bg-white rounded-2xl border border-line p-6 shadow-2xs space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-1">
              ...
              >
                ...
                <span className="text-[10px] text-ink-muted mt-1">Start fresh</span>
              </button>
              ...
              {TEMPLATES.map((tmpl) => (
                <div
                  ...
                  className="rounded-2xl border border-line hover:border-bridge-teal p-3.5 bg-paper hover:bg-white transition-all cursor-pointer flex flex-col justify-between aspect-3/4 group"
                >
                  <div className="space-y-2">
                    <span className="text-[10px] font-mono font-bold uppercase tracking-wider px-2 py-0.5 rounded-md bg-white border border-line text-ink-muted block text-center">
                      {tmpl.badge}
                    </span>
                    <h4 className="font-serif font-bold text-xs text-ink group-hover:text-bridge-teal transition-colors">
                      {tmpl.name}
                    </h4>
                    <p className="text-[11px] text-ink-muted leading-tight line-clamp-3">
                      {tmpl.description}
                    </p>
                  </div>

                  <button className="w-full py-1.5 rounded-lg bg-white group-hover:bg-bridge-teal group-hover:text-white border border-line text-[11px] font-semibold text-ink transition-colors text-center">
                    Use Template →
                  </button>
                </div>
              ))}
          ...
          <div className="bg-white rounded-2xl border border-line p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-line">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-serif text-base font-bold text-ink">My Resumes</h3>
                <span className="px-2 py-0.5 rounded-full bg-paper border border-line text-xs font-mono font-bold text-ink-muted">
            ...
            {resumes.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-line text-ink-muted font-mono uppercase text-[11px]">
                  ...
                  <tbody className="divide-y divide-line">
                    {resumes.map((res) => (
                      <tr key={res.id} className="hover:bg-paper/60 transition-colors">
                        ...
                        <td className="py-4 font-mono text-ink-muted">
                          <span
                          ...
                          <div className="flex items-center justify-end gap-2">
                            {res.type !== 'UPLOADED' && (
                              <button
                                ...
                                className="px-3 py-1.5 rounded-lg bg-paper hover:bg-line border border-line text-ink font-semibold text-xs flex items-center gap-1"
                              >
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded-lg ${
                                res.isPrimary ? 'text-amber-500' : 'text-ink-muted hover:text-amber-500'
                              }`}
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-ink-muted hover:text-status-red"
                              title="Delete Resume"
                            >
              ...
              <div className="p-8 text-center bg-paper rounded-2xl border border-line space-y-4">
                <div className="w-12 h-12 rounded-2xl bg-white border border-line text-bridge-teal flex items-center justify-center mx-auto shadow-2xs">
                ...
                <div className="flex items-center justify-center gap-3 pt-2">
                  ...
                  <button
                    onClick={() => uploadInputRef.current?.click()}
                    className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-white border border-line text-ink text-xs font-semibold hover:border-bridge-teal transition-colors"
                  >
                    <Upload className="w-4 h-4 text-bridge-teal" />
      ...
      {activeResume && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-line p-4 shadow-2xs flex items-center justify-between gap-3">
              <div className="flex-1">
                <label className="text-[10px] font-mono uppercase text-ink-muted block">Resume Document Title</label>
                <input
                  type="text"
                  ...
                  className="font-serif font-bold text-base text-ink bg-transparent border-b border-transparent hover:border-line focus:border-bridge-teal focus:outline-none w-full py-0.5"
                />
              </div>
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              <button
                ...
                className="w-full px-5 py-3.5 flex items-center justify-between bg-paper hover:bg-line/40 transition-colors text-left"
              >
                <div className="flex items-center gap-2.5">
                  <User className="w-4 h-4 text-bridge-teal" />
                  <span className="font-serif font-bold text-xs text-ink">1. Basic Details</span>
                </div>
                {expandedSections.basic ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>

              {expandedSections.basic && (
                <div className="p-5 space-y-3 text-xs border-t border-line">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="font-semibold text-ink block mb-1">Full Name</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="font-semibold text-ink block mb-1">Target Headline</label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <label className="font-semibold text-ink block mb-1">Email</label>
                      <input
                        type="email"
                    ...
                    <div>
                      <label className="font-semibold text-ink block mb-1">Phone</label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label className="font-semibold text-ink block mb-1">Location</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="font-semibold text-ink block mb-1">Professional Summary</label>
                    <textarea
                      rows={3}
                      ...
                      className="w-full bg-paper border border-line rounded-xl p-3 text-xs text-ink focus:outline-none focus:border-bridge-teal leading-relaxed"
                    />
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">2. Skills & Competencies</span>
                  <span className="px-2 py-0.5 rounded-full bg-white border border-line text-[10.5px] font-mono font-bold text-ink-muted">
                    {(activeResume.content.skills || []).length}
                  </span>
                </div>
                {expandedSections.skills ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>
                ...
                <div className="p-5 space-y-3 text-xs border-t border-line">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 bg-paper border border-line rounded-xl px-3 py-2 text-xs text-ink focus:outline-none focus:border-bridge-teal"
                    />
                    <button
                      type="button"
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    {(activeResume.content.skills || []).map((skill: string, idx: number) => (
                      <span
                        key={idx}
                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-paper border border-line text-xs font-mono text-ink"
                      >
                        <span>{skill}</span>
                        <button
                          type="button"
                          onClick={() => handleRemoveSkill(skill)}
                          className="text-ink-muted hover:text-status-red"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </span>
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">3. Education</span>
                  <span className="px-2 py-0.5 rounded-full bg-white border border-line text-[10.5px] font-mono font-bold text-ink-muted">
                    {(activeResume.content.educations || []).length}
                  </span>
                </div>
                {expandedSections.education ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>

              {expandedSections.education && (
                <div className="p-5 space-y-4 text-xs border-t border-line">
                  {(activeResume.content.educations || []).map((edu: any, index: number) => (
                    <div key={edu.id || index} className="p-3.5 rounded-xl bg-paper border border-line space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-ink">Education #{index + 1}</span>
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className="text-ink-muted hover:text-status-red p-1"
                        >
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        <input
                          ...
                          className="bg-white border border-line rounded-lg px-3 py-1.5 text-xs text-ink focus:outline-none focus:border-bridge-teal"
                        />
                        <input
                          type="text"
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">4. Experience</span>
                  <span className="px-2 py-0.5 rounded-full bg-white border border-line text-[10.5px] font-mono font-bold text-ink-muted">
                    {(activeResume.content.experiences || []).length}
                  </span>
                </div>
                {expandedSections.experience ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>

              {expandedSections.experience && (
                <div className="p-5 space-y-4 text-xs border-t border-line">
                  {(activeResume.content.experiences || []).map((exp: any, index: number) => (
                    <div key={exp.id || index} className="p-3.5 rounded-xl bg-paper border border-line space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-ink">Experience #{index + 1}</span>
                        <button
                          type="button"
                          onClick={() => {
                      ...
                      <textarea
                        ...
                        className="w-full bg-white border border-line rounded-lg p-2 text-xs text-ink focus:outline-none focus:border-bridge-teal"
                      />
                    </div>
                  ))}
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">5. Responsibilities</span>
                  <span className="px-2 py-0.5 rounded-full bg-white border border-line text-[10.5px] font-mono font-bold text-ink-muted">
                    {(activeResume.content.responsibilities || []).length}
                  </span>
                </div>
                {expandedSections.responsibilities ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>

              {expandedSections.responsibilities && (
                <div className="p-5 space-y-4 text-xs border-t border-line">
                  {(activeResume.content.responsibilities || []).map((resp: any, index: number) => (
                    <div key={resp.id || index} className="p-3 rounded-xl bg-paper border border-line space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-ink">Position #{index + 1}</span>
                        <button
                          type="button"
                          onClick={() => {
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">6. Projects</span>
                  <span className="px-2 py-0.5 rounded-full bg-white border border-line text-[10.5px] font-mono font-bold text-ink-muted">
                    {(activeResume.content.projects || []).length}
                  </span>
                </div>
                {expandedSections.projects ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>

              {expandedSections.projects && (
                <div className="p-5 space-y-4 text-xs border-t border-line">
                  {(activeResume.content.projects || []).map((proj: any, index: number) => (
                    <div key={proj.id || index} className="p-3.5 rounded-xl bg-paper border border-line space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-ink">Project #{index + 1}</span>
                        <button
                          type="button"
                          onClick={() => {
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        ...
                        <input
                          ...
                          className="bg-white border border-line rounded-lg px-3 py-1.5 text-xs text-ink focus:outline-none focus:border-bridge-teal font-mono"
                        />
                      </div>
            ...
            <div className="bg-white rounded-2xl border border-line shadow-2xs overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-serif font-bold text-xs text-ink">7. Social & Professional Links</span>
                </div>
                {expandedSections.socials ? <ChevronUp className="w-4 h-4 text-ink-muted" /> : <ChevronDown className="w-4 h-4 text-ink-muted" />}
              </button>
              ...
              {expandedSections.socials && (
                <div className="p-5 space-y-3 text-xs border-t border-line">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="font-semibold text-ink block mb-1 flex items-center gap-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-paper border border-line rounded-xl px-3 py-2 text-xs text-ink focus:outline-none focus:border-bridge-teal font-mono"
                      />
                    </div>
          ...
          <div className="lg:col-span-6 space-y-4 lg:sticky lg:top-20">
            {/* Live Controls Bar */}
            <div className="bg-white rounded-2xl border border-line p-3 shadow-2xs flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-mono uppercase font-bold text-ink-muted">Template:</span>
                <select
                  ...
                  className="bg-paper border border-line rounded-lg px-2.5 py-1 text-xs font-semibold text-ink focus:outline-none focus:border-bridge-teal"
                >
                  {TEMPLATES.map((tmpl) => (
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => handleDownloadPDF(activeResume)}
                  className="p-1.5 rounded-lg bg-paper hover:bg-line border border-line text-ink"
            ...
            <div className="bg-white border border-line rounded-2xl p-7 shadow-lg min-h-[620px] font-sans text-xs space-y-4">
              {/* Header */}
      ...
      {isChoiceModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="bg-white rounded-2xl border border-line shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-line flex items-center justify-between">
              <div>
                <h3 className="font-serif font-bold text-lg text-ink">Choose Creation Option</h3>
                <p className="text-xs text-ink-muted">Select how you want to initialize your resume draft</p>
              </div>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div
                ...
                className={`p-5 rounded-2xl border-2 cursor-pointer transition-all flex items-start gap-4 ${
                  creationMethod === 'profile'
                    ? 'border-bridge-teal bg-bridge-teal/5 shadow-2xs'
                    : 'border-line hover:border-bridge-teal/50 bg-paper'
                }`}
              >
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
                    creationMethod === 'profile'
                      ...
                      : 'bg-white border border-line text-bridge-teal'
                  }`}
                >
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <h4 className="font-serif font-bold text-sm text-ink">Fetch From Profile</h4>
                    <span className="px-2 py-0.5 rounded-full bg-bridge-teal/15 text-bridge-teal text-[10px] font-mono font-bold">
                      Recommended
                    </span>
                  </div>
              ...
              >
                ...
                <div className="space-y-1">
                  <h4 className="font-serif font-bold text-sm text-ink">Create New Resume</h4>
                  <p className="text-xs text-ink-muted leading-relaxed">
