  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Industry Partner */}
        <div className="bg-[#0b1329] border border-[#1e293b] rounded-xl p-4 flex items-start gap-3.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            {collaboration.company?.website && (
              <a
                ...
                className="inline-flex items-center gap-1 text-xs text-blue-400 hover:underline mt-1.5"
              >
          ...
          <div className="pt-3 border-t border-[#1e293b]">
            ...
            <div className="flex flex-wrap gap-1.5">
              {parsedSkills.map((sk, idx) => (
                <span
                  key={idx}
                  className="px-2.5 py-1 rounded-lg bg-[#0f172a] border border-[#1e293b] text-xs text-slate-300 flex items-center gap-1"
                >
      ...
      <div className="bg-[#0b1329] border border-[#1e293b] rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
          <div className="p-3 bg-[#0f172a] border border-[#1e293b] rounded-xl">
            <span className="text-slate-500 block mb-1">Proposed Timeline</span>
          ...
          <div className="p-3 bg-[#0f172a] border border-[#1e293b] rounded-xl">
            <span className="text-slate-500 block mb-1">Active Duration</span>
            <span className="font-semibold text-slate-200">
              {startDateFormatted
          ...
          <div className="p-3 bg-[#0f172a] border border-[#1e293b] rounded-xl">
            <span className="text-slate-500 block mb-1">Proposed Date</span>
            <span className="font-semibold text-slate-200">{createdFormatted}</span>
          </div>

          <div className="p-3 bg-[#0f172a] border border-[#1e293b] rounded-xl">
            <span className="text-slate-500 block mb-1">Last Update</span>
            <span className="font-semibold text-slate-200">{updatedFormatted}</span>
          </div>
        </div>
      </div>
    </div>
